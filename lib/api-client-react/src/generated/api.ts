 ...
 */
export const submitContact = async (contactInput: ContactInput, options?: RequestInit): Promise<FormResponse> => {

  return customFetch<FormResponse>(getSubmitContactUrl(),
  {
    ...options,
    method: 'POST',
 ...
 */
export const submitVolunteer = async (volunteerInput: VolunteerInput, options?: RequestInit): Promise<FormResponse> => {

  return customFetch<FormResponse>(getSubmitVolunteerUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
